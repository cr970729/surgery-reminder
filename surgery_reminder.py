...
def main():
    ...
    message = (
        ...
        f"检查范围：{room_range}\n"
        f"本周轮到你检查手术室啦！\n"
        f"在线编辑：https://alidocs.dingtalk.com/i/nodes/gwva2dxOW4Kbraq4sBrLmQrw8bkz3BRL?corpId=dingf0163b493eb8569f&utm_medium=im_card&iframeQuery=sheet_range%3Dst-981bd886-35240_0_7_1_1%26utm_medium%3Dim_card%26utm_source%3Dim&utm_scene=person_space&utm_source=im"
    )
